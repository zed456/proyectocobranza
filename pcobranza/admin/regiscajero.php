      ...
      <div class="row">
        <div class="col-md-3">
          <div class="card">
            ...
            <form class="p-4" action="insertarcajero.php" method="POST">
              <input type="text" class="form-control mb-3" name="id_cajero" placeholder="Matricula de cajero.">
          ...
          <table class="table custom-table">
            ...
            <tbody>
              <tr scope="row">
                ...
                <td><?php echo $registro['id_cajero']; ?></td>
                <td><?php echo $registro['password']; ?></td>
                <td><?php echo $registro['Nombre']; ?></td>
                <td><?php echo $registro['Apellido_P']; ?></td>
                <td><?php echo $registro['Apellido_M']; ?></td>
                <td><?php echo $registro['Genero']; ?></td>
                <td><?php echo $registro['Teléfono']; ?></td>
                <td> <a href="editarcajero.php?valor=<?php echo $registro['id_cajero'];?>">Editar</a></td>
                <td> <a href="deletcajero.php?valor=<?php echo $registro['id_cajero'];?>">Elimar</a></td>
              </tr>
            </tbody>
            <?php
              }?>
