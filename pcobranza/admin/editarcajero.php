...
$query = "SELECT * FROM caja where id_cajero = '$id_cajero'";
      ...
      <div class="row justify-content-center">
        <div class="col-md-4">
          <div class="card">
            ...
            <form class="p-4" action="actualizarcajero.php" method="POST">
              <?php
              ...
              <div class="d-grid">
                <input type="hidden" name="id_cajero" value="<?php echo $registro['id_cajero']; ?>">
