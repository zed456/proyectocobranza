...
$query = "SELECT * FROM enfermero where id_enfermero = '$id_enfermero'";
      ...
      <div class="row justify-content-center">
        <div class="col-md-4">
          <div class="card">
            ...
            <form class="p-4" action="actualizarenfer.php" method="POST">
              <?php
              ...
              <input type="text" class="form-control mb-3" name="Tel" value="<?php echo $registro['Teléfono']; ?>">
              <div class="d-grid">
                <input type="hidden" name="id_enfermero" value="<?php echo $registro['id_enfermero']; ?>">
